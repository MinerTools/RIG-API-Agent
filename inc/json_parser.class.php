	...
	public function parse_all_json_rpc_calls()
	{
		...
		foreach ($this->server_list as $name => $server) {
			...
			if ($this->miner_status->{$name} == 1) {
				...
				$data = '{"id":1,"jsonrpc":"2.0","method":"miner_getstat2"' . $append . '} ' . "\r\n\r\n";
